...
def get_user_repository() -> JSONRepository:
    """Dependency injection for user repository."""
    return JSONRepository(settings.users_db_path, "users")


def get_user_service(repo: JSONRepository = Depends(get_user_repository)) -> UserService:
